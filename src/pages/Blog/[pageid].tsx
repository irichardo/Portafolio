...
export default function BlogPage({ postData }: any) {
  ...
  return (
    <main className="w-screen h-screen bg-purple-700 overflow-x-hidden relative">
      ...
      <div className="w-full h-auto flex flex-col items-center justify-center">
        <p className="w-full min-h-[10vw] bg-purple-500 items-center justify-center flex">{postData.content}</p>
        <div className="w-[70%] h-[80vh] bg-slate-500 flex flex-col items-center">
          ...
          <p className="w-5/6 h-full bg-pink-500">
            </p>
        </div>
      </div>
      <footer className="w-full h-[10%] bg-red-950 flex items-center justify-center">
        ...
        <button onClick={backToPage} className="w-1/5 h-full bg bg-purple-400 grid place-items-center hover:bg-purple-800">
          <MdMenu size={30}/>
        </button>
        <button className="w-1/5 h-full bg bg-purple-400 hover:bg-purple-800">
          Siguiente
      ...
      {/* <div className="w-[90%] h-5/6 bg-red-700">

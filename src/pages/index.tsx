...
export default function Home () {
  return (
    ...
    <main className={`flex flex-col items-center justify-between overflow-hidden`}>
      ...
      <section className='w-screen min-h-screen md:h-screen relative bg-gray-900' id='Habilidades'>
        <Habilidades />
      </section>
      <section className='w-screen h-screen relative bg-gray-900 ' id='Proyectos'>
        <Projects />
      </section>
      <section className='w-screen h-screen relative bg-gray-900 items-center justify-center flex ' id='Contacto'>
        <ContactComp />
      </section>
    </main>
    </Layout>

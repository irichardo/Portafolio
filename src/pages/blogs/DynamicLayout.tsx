  ...
  return (
    <main>
      ...
      <div className="w-screen h-[12vh] bg-slate-800 flex items-center justify-center md:justify-start">
        <Link href={'/blogs'} className="w-[20vh] h-1/2 font-chakra text-white items-center flex justify-center bg-slate-950 rounded-md"><span className="block md:hidden">Volver </span><MdArrowBackIos className="hidden md:block"/></Link>
      </div>
      {children}

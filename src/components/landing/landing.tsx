            ...
            <div className='w-full h-full flex flex-col items-center justify-center'>
              <div className='w-full h-1/2 items-center justify-center flex'>
                <motion.div
                  ...
                  className='w-[90%] h-[90%] items-center justify-center flex bg-rose-600  text-white text-3xl'
                >
                  <Image
                    src='/logonobg.svg'
                    width={600}
              ...
              <div className='w-full h-1/2 flex flex-col items-center justify-center'>
                <motion.h1
                  ...
                  transition={{ duration: 2, delay: 0.5, ease: 'easeInOut' }}
                  className='p-2 text-3xl font-montserrat font-bold text-orange-300'
                >
                  RichardHD
                </motion.h1>
                <h2
                  className={`p-2 transition-all text-3xl font-montserrat font-bold text-orange-300 `}
                >
                  Desarrolador web
                </h2>
              </div>

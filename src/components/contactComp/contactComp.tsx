        ...
        <div className=' w-5/6 h-5/6 bg-white rounded-3xl'>
          <div className='h-2/6 w-full flex flex-col items-center justify-center'>
            ...
            <div className='w-5/6 h-full flex'>
              <button id="Job" type='button' className={`w-40 h-10 ${form.data === valueButton.jobProp ? 'bg-red-700 text-white shadow-md shadow-slate-700' : 'bg-white text-gray-400 border-gray-600'} rounded-md border text-xs sm:text-sm m-2 cursor-default transition-shadow`} value={valueButton.jobProp} onClick={HandlerForm}>
                Propuesta de trabajo
              </button>
              <button id="Project" type='button' className={`w-40 h-10 ${form.data === valueButton.project ? 'bg-red-700 text-white shadow-md shadow-slate-700' : 'bg-white text-gray-400 border-gray-600'} rounded-md border text-xs sm:text-sm m-2 cursor-default transition-shadow`} value={valueButton.project} onClick={HandlerForm}>
                Proyecto
              </button>
            </div>
          </div>

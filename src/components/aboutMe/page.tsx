        ...
        <div className='w-4/6 h-full  flex items-center justify-center'>
          <div className='w-11/12 h-1/2'>
            <div className='w-full h-4/6'>
              <p className='w-full h-full flex flex-col items-center text-center text-lg font-semibold'>
                Hola!, mi nombre es Ricardo, mis amigos me suelen llamar 'Richard'.
                Soy un desarrollador web en crecimiento.<br/>
                He trabajado en varios proyectos independientes,
                me encanta aprender cosas nuevas, equivocar, recibir feedback y ponerme a prueba con cada conocimiento que obtengo, como este portafolio/devblog!, 
                ...
                igualmente estoy disponible para cualquier proyecto freelance.<br/> Mi objetivo principal es poder costearme mis estudios de ciberseguridad 💜. <br/><p className="text-red-500 animate-bounce delay-700 m-4">Muchas gracias por tu tiempo.</p> 
              </p>
            </div>
